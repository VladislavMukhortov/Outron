        ...
        return [
            ...
            'step_eight_check_in_hour_cannot_be_less_than_1' => [
                ...
                [
                    'info' => [
                        'check_in_hour' => [
                            'Значение поля Час заезда должно быть не меньше 1.',
                        ],
                    ],
                ],
            ],
            'step_eight_check_in_hour_cannot_be_more_than_60' => [
                ...
                [
                    'info' => [
                        'check_in_hour' => [
                            'Значение поля Час заезда не может быть больше 60.',
                        ],
                    ],
                ],
            ],
            'step_eight_check_out_hour_cannot_be_less_than_1' => [
                ...
                [
                    'info' => [
                        'check_out_hour' => [
                            'Значение поля Час выезда должно быть не меньше 1.',
                        ],
                    ],
                ],
            ],
            'step_eight_check_out_hour_cannot_be_more_than_60' => [
                ...
                [
                    'info' => [
                        'check_out_hour' => [
                            'Значение поля Час выезда не может быть больше 60.',
                        ],
                    ],
                ],
            ],
